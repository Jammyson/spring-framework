...
public class ResourceUrlEncodingFilterTests {
	...
	public void encodeUrlWithRequestParams() throws Exception {
		...
		testEncodeUrl(request, "/resources/bar.css?foo=bar&url=https://example1.org",
				"/resources/bar-11e16cf79faee7ac698c805cf28248d2.css?foo=bar&url=https://example1.org");
	}
	...
	public void encodeUrlWithFragment() throws Exception {
		...
		testEncodeUrl(request,
				"/resources/bar.css?foo=bar&url=https://example1.org#something",
				"/resources/bar-11e16cf79faee7ac698c805cf28248d2.css?foo=bar&url=https://example1.org#something");
	}
